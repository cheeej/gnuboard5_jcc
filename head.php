...
<div id="hd">
    ...
    <div id="hd_wrapper">
      <div class="inner">
        <div id="logo">
            <a href="http://chej1122.cafe24.com/gnuboard5/">JCC</a>
        </div>
        <nav id="gnb">
         <h2>메인메뉴</h2> 
            <div class="gnb_wrap">
                <ul id="gnb_1dul">
                <li class="gnb_1dli gnb_mnal"></li>
                    <?php
            ...
            <div class="utll">
                <button type="button" class="gnb_search_btn" title="전체메뉴"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">전체메뉴열기</span></button>
